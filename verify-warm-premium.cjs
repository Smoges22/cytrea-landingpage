...
const baseline = "751601e6227ecd5c815d42bec630df5409420fea";
const out = path.join(root, ".verification/final-warm-premium/technical");
...
async function main() {
  ...
  const sourceFiles = ["cytrea.css", "cytrea.js", "download-config.js", "sync-downloads.cjs", "sync-forms.cjs", "form-config.js", "forms.js", "vendor-intake.js", expectedFontAsset.slice(1), ...pageRoutes.map(route => route === "/" ? "index.html" : `${route.slice(1)}.html`)];
